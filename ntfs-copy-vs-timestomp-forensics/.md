...
# NTFS Copy vs Timestomp Forensics

> Detecting copied files and timestamp manipulation using FTK Imager and MFT Explorer

[![Platform](https://img.shields.io/badge/Platform-Windows_11-blue)]()
[![Filesystem](https://img.shields.io/badge/Filesystem-NTFS-green)]()
[![Tool](https://img.shields.io/badge/Tool-MFT_Explorer-orange)]()
[![Status](https://img.shields.io/badge/Case-Completed-success)]()
...
- [Methodology](#methodology)
  - [Phase 1: Create a New File](#phase-1-create-a-new-file)
  - [Phase 2: Copy the File](#phase-2-copy-the-file)
  - [Phase 3: Perform Timestomping](#phase-3-perform-timestomping)
  - [Phase 4: MFT Analysis](#phase-4-mft-analysis)
- [Key Findings](#key-findings)
- [DFIR Takeaways](#dfir-takeaways)
...
A text file was created using Command Prompt.

Immediately after creation, all three Windows timestamps were identical because the file had not yet been modified or accessed.
...
<img width="947" height="296" alt="2" src="https://github.com/user-attachments/assets/c9501df6-b31a-4b58-811f-3aeee1a4b339" />

---

## Phase 2: Copy the File

The file was copied to another location.

NTFS preserved the **Date Modified** timestamp from the original file while assigning new **Date Created** and **Date Accessed** values to the copied file.
...
<img width="959" height="288" alt="3" src="https://github.com/user-attachments/assets/af04db55-d4dd-47e8-ba23-f147ed713db3" />
...
<img width="964" height="477" alt="4" src="https://github.com/user-attachments/assets/b12c5a8e-bf2d-4389-bffb-974339e2c8c9" />

<img width="1095" height="463" alt="5" src="https://github.com/user-attachments/assets/cfef6605-e6d1-43d6-b6df-1dc648d979da" />

---

## Phase 4: MFT Analysis

The NTFS **$MFT** was exported using FTK Imager and examined with **MFT Explorer**.

The directory containing the test files was filtered to compare metadata between the copied and timestomped files.

| Field | Forensic Significance |
|--------|----------------------|
| **Copied** | Indicates whether the file record was created through a copy operation |
| **SI&lt;FN** | Shows SI timestamps occurring earlier than FN timestamps, a strong timestomping indicator |
...
<img width="1816" height="406" alt="6" src="https://github.com/user-attachments/assets/f6337bd0-6ce6-4a78-9a58-1fc889b1fa3c" />
